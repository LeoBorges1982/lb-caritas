    ...
    <>
      {!aberto && (
        <button onClick={() => setAberto(true)}
          className="no-print print:hidden fixed bottom-6 right-6 z-40 bg-gradient-to-br from-[#1e3a8a] to-[#d4af37] text-white p-4 rounded-full shadow-xl hover:scale-105 transition-transform"
      ...
      {aberto && (
        <div className="no-print print:hidden fixed bottom-6 right-6 z-40 w-[380px] max-w-[calc(100vw-2rem)] h-[560px] max-h-[calc(100vh-3rem)] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-slate-200">
